    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">The Painful Reality:</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {problems.map((problem, index) => {
            ...
            return (
              <div key={index} className="bg-white p-8 rounded-xl border-2 border-red-100 hover:border-red-200 transition-colors">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon className="text-red-600" sx={{ fontSize: 28 }} />
                  </div>
                  <div>
