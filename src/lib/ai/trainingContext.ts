...
export class TrainingContext {
   ...
   * Only includes words that are genuinely harmful marketing fluff with no legitimate use
   */
  static readonly PROHIBITED_WORDS = [
    // Absolute marketing fluff — no legitimate product use
    'BEST SELLER', 'BEST SELLING', 'BEST RATED', 'TOP RATED', 'TOP SELLER',
    'AWARD WINNING', 'WORLD CLASS', 'INDUSTRY LEADING', 'MARKET LEADING',
    'GAME CHANGER', 'LIFE CHANGING', 'REVOLUTIONARY', 'BREAKTHROUGH',
    'MIRACLE', 'MAGIC', 'MAGICAL', 'INSTANT RESULTS', 'EASY MONEY',
    'SOLVE YOUR PROBLEM', 'SOLVE YOUR PROBLEMS', 'SOLVES YOUR PROBLEM',
    'PROBLEM SOLVER', 'ULTIMATE SOLUTION', 'PERFECT SOLUTION',
    'BEST VALUE', 'BEST CHOICE', 'TOP CHOICE', 'FIRST CHOICE',
    'MUST HAVE', 'MUST-HAVE', 'CANT LIVE WITHOUT',
    'TRANSFORM YOUR LIFE', 'CHANGE YOUR LIFE', 'CHANGE EVERYTHING',
    'NEVER BEFORE SEEN', 'CUTTING EDGE TECHNOLOGY', 'STATE OF THE ART',
    'NEXT LEVEL PERFORMANCE', 'ELEVATE YOUR GAME', 'UNLOCK YOUR POTENTIAL',
    'DISCOVER THE SECRET', 'PROFESSIONAL GRADE', 'PROFESSIONAL-GRADE',
    'MILITARY GRADE', 'MILITARY-GRADE', 'HOSPITAL GRADE', 'COMMERCIAL GRADE',
    'STUDIO QUALITY', 'PREMIUM QUALITY', 'HIGH QUALITY', 'TOP QUALITY',
    'SUPERIOR QUALITY', 'GUARANTEED RESULTS', 'PROVEN RESULTS',
    'AMAZING RESULTS', 'INCREDIBLE RESULTS', 'OUTSTANDING RESULTS',
    'EXCEPTIONAL RESULTS',
    // Standalone filler adjectives — add no value
    'PREMIUM', 'LUXURY', 'EXCLUSIVE', 'SUPERIOR', 'EXCEPTIONAL',
    'OUTSTANDING', 'REMARKABLE', 'INCREDIBLE', 'AMAZING', 'STUNNING',
    'REVOLUTIONARY', 'INNOVATIVE', 'CUTTING-EDGE', 'NEXT-GENERATION',
    'PROFESSIONAL', 'ELITE', 'DELUXE', 'ULTIMATE', 'PERFECT'
  ];
