...
export class TrainingContext {
  ...
  static readonly PROHIBITED_WORDS = [
    ...
    'DISCOVER THE SECRET', 'PROFESSIONAL GRADE', 'MILITARY GRADE',
    'HOSPITAL GRADE', 'COMMERCIAL GRADE', 'STUDIO QUALITY',
    'PREMIUM QUALITY', 'HIGH QUALITY', 'TOP QUALITY', 'SUPERIOR QUALITY',
    'GUARANTEED RESULTS', 'PROVEN RESULTS', 'AMAZING RESULTS',
    'INCREDIBLE RESULTS', 'OUTSTANDING RESULTS', 'EXCEPTIONAL RESULTS'
  ];
